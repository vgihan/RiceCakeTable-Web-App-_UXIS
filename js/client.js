...
function show(purpose){
    ...
    console.log('userStream[meeting]:',userStreams['meeting']);
    console.log("receiveVideos[meeting]:",receiveVideos['meeting'])
    //console.log('userStream[share]:',userStreams['share']);
    //console.log("receiveVideos[share]:",receiveVideos['share'])
    socket.emit('show',purpose);
    for (var key in receiveVideos['meeting']){
        console.log(key)
    }
