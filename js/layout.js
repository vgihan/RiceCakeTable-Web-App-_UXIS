$(function(){
	...
	$('.header .r_hcont .second .h_btn.p_people').click(function(event) {
		...
		if(!shareSwitch) {
			if(socket.id === shareSocketId) document.getElementsByClassName('chat1_1_cc')[0].style = "display: none;";
	...
	$('.header .r_hcont .second .h_btn.share').click(function(event) {
		...
		if(!shareSwitch) {
			if(socket.id === shareSocketId) document.getElementsByClassName('chat1_1_cc')[0].style = "display: block;";
